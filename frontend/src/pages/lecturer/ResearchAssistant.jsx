  ...
  return (
    <Box>
      ...
      <Typography variant="body1" color="text.secondary" mb={2}>
        Upload a research paper (PDF) to get an AI-generated summary, key findings, research gaps, and future work.
      </Typography>
        ...
        <Box>
          <Card sx={{ mb: 2 }}>
            <CardContent>
              ...
              <Chip label={`${result.extractedCharacterCount} characters extracted`} size="small" sx={{ mb: 2 }} />
              <Box mb={2}>
